...
To make this a more complete and current piece of journalism, I would want to redo the study using more modern purchase data, from multiple retailers across different regions. I would also want to interview SNAP recipients directly about their shopping decisions and constraints, to understand the reasoning behind their purchases. Lastly, I would look at outcomes in the states that have already implemented soda and candy restrictions to see how policy impacts purchase data. 
